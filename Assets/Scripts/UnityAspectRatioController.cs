...
/// </summary>
public class UnityAspectRatioController : MonoBehaviour
{
    /// <summary>
    ...
    [SerializeField]
    private int minWidthPixel = 200;
    [SerializeField]
    private int minHeightPixel = 150;
    [SerializeField]
    private int maxWidthPixel = 800;
    [SerializeField]
    private int maxHeightPixel = 600;
    ...
    private const int WM_SIZE = 0x005;
    ...
    //MY SHIT DONT LOSE IT MY SHIT DONT LOSE ITMY SHIT DONT LOSE ITMY SHIT DONT LOSE ITMY SHIT DONT LOSE ITMY SHIT DONT LOSE ITMY SHIT DONT LOSE ITMY SHIT DONT LOSE IT
    [DllImport("user32.dll")]
    private static extern bool GetWindowLongPtr(IntPtr hWnd, ref IntPtr dwNewLong);
    ...
    IntPtr wndProc(IntPtr hWnd, uint msg, IntPtr wParam, IntPtr lParam)
    {
        ...
        if (msg == WM_SIZE)
        {
            Screen.SetResolution(maxWidthPixel, maxHeightPixel, false);
        }
    ...
    void Update()
    {
        ...
        else if (Screen.width != setWidth || Screen.height != setHeight)
        {
